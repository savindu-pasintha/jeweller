    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#customerpage").click(function() {
                $("#col5").hide();
                $("#col6").hide();
                $("#load").load("customer.php");
            });
            $("#registerpage").click(function() {
                $("#col5").hide();
                $("#col6").hide();
                $("#load").load("Register.php");
            });
            $("#productviewpage").click(function() {
                $("#col5").hide();
                $("#col6").hide();
                $("#load").load("viewproduct.php");
            });
        });
    </script>
    <script type="text/javascript">
...
<body>
    <div class="container-fluid maincontainer">
        <div class="row mainrow">
            <div class="col-md-2 maincol maincol1">
                ...
                <ul id="ul">
                    ...
                    <li>
                        <button id="productpage" type="button" class="btn btn-primary">PRODUCT</button>
                    </li>
                    <li>
                        <button id="productviewpage" type="button" class="btn btn-info">View Product</button>
                    </li>
                    <li>
                        <button id="orderpage" type="button" class="btn btn-warning">ORDERS</button>
                    </li>
                    <li>
                        <button id="customerpage" type="button" class="btn btn-light">CUSTOMERS</button>
                    </li>
                    <li>
                        <button id="registerpage" type="button" class="btn btn-info">REGISTRATIONS</button>
                    </li>
            ...
            <div id="col5" class="col-md-4   maincol maincol2">
            ...
            <div id="col6" class="col-md-6   maincol maincol3">
                <div class="overflow-auto bg-light" style="width:100%; height:100%;">
                    <ul>
                        <li class="dropdown-item">
            ...
            <div class=" col-md-10 remove" id="colmd10">
                <!--- scrolabele page-->
                <div id="load" class="overflow-auto bg-light" style="width:100%; height:400px;">
                </div>
            </div>
            <!---   <div id="product" class="col-md-1"></div>-->
...
function fileupload()
{
    ...
    //$uploadedfilename = "https://devijewellers.lk/wp-content/uploads/2020/07/45.jpg";
